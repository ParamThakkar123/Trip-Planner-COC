        ...
        <div className='h-screen w-screen overflow-hidden relative'>
            ...
            <form action="" className='absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white'>
                ...
                <div className='flex items-center justify-center mt-5'>
                    <button type='submit' className='mt-4 bg-white text-xl text-black w-full p-2 rounded btn btn-background-slide'>Sign up</button>
                </div>
                <span className='text-lg mt-5'>Already have an account? <Link href='/login'>Login</Link></span>
                </div>
            </form>
        </div>
    </div>
